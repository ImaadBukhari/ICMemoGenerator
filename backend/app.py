...
# from backend.routes.auth import router as auth_router  # Commented out for local testing
...
# Database setup - COMMENTED OUT FOR LOCAL TESTING
# DATABASE_URL = os.getenv("DATABASE_URL")
# engine = create_engine(DATABASE_URL)
# SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine)

# Create tables - COMMENTED OUT FOR LOCAL TESTING
# Base.metadata.create_all(bind=engine)

# Mock database session for local testing
from backend.mock_models import MockSession
...
# Include routers
# app.include_router(auth_router, prefix="/api")  # Commented out for local testing
